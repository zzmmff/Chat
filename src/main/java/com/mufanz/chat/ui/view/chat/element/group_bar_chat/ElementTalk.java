package com.mufanz.chat.ui.view.chat.element.group_bar_chat;

import com.mufanz.chat.ui.util.DateUtil;
 ...
 * @Description 对话框元素，好友对话框列表
 * @Author 张慕帆
 * @Date 3:52 PM 3/18/2022
 * @Version 1.0
 **/
public class ElementTalk {
    ...
    public ElementTalk(String talkId, Integer talkType, String talkName, String talkHead, String talkSketch, Date talkDate) {
        ...
        head.setStyle(String.format("-fx-background-image: url('"+getClass().getResource("/fxml/chat/img/head/"+talkHead+".png").toExternalForm()+"')"));
        children.add(head);
